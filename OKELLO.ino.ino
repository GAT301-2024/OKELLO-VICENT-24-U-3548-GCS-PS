...
String htmlPage()
{
  ...
  <head>
      ...
      <title>OKELLO VICENT Systems - Smart Lighting</title>
      <style>
          body {
  ...
  <body>
      ...
      <footer>&copy; 2025 OKELLO VICENT Systems | BYTEBLOOM GAT301</footer>
  </body>
  </html>
  )rawliteral";
